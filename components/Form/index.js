...
const OrderForm = () => {
  ...
  useEffect(() => {
    if (dbname === "ids") {
          ...
          {name:'lipid11', label:'Vaccine Application'},
          {name:'lipid12', label:'Conserved'},
          {name:'lipid13', label:'Variant Targets'},
          {name:'lipid14', label:'Category'},
          {name:'lipid21', label:'Type'},
          {name:'lipid22', label:'Subcategory'},
          {name:'lipid23', label:'Description'},
          {name:'lipid24', label:'FACTAtarget'},
          {name:'lipid31', label:'FACTAGenome'},
          {name:'lipid32', label:'Amino Acid'},
          {name:'lipid33', label:'IPReference'},
          {name:'lipid34', label:'Publication Source'},
          {name:'lipid41', label:'DOI'},
          {name:'lipid42', label:'PANGO'},
          {name:'lipid43', label:'AmpTec Sourcecode'},
          {name:'lipid44', label:'RNAseqCHECK'}
          ]);
