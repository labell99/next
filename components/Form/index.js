...
const OrderForm = () => {
  ...
  useEffect(() => {
    ...
    if (dbname === "ids") {
          ...
          {name:'Lipid_1_1', label:'Lipid11'},
          {name:'Lipid_1_2', label:'Lipid12'},
          {name:'Lipid_1_3', label:'Lipid13'},
          {name:'Lipid_1_4', label:'Lipid14'},
          {name:'Lipid_2_1', label:'Lipid21'},
          {name:'Lipid_2_2', label:'Lipid22'},
          {name:'Lipid_2_3', label:'Lipid23'},
          {name:'Lipid_2_4', label:'Lipid24'},
          {name:'Lipid_3_1', label:'Lipid31'},
          {name:'Lipid_3_2', label:'Lipid32'},
          {name:'Lipid_3_3', label:'Lipid33'},
          {name:'Lipid_3_4', label:'Lipid34'},
          {name:'Lipid_4_1', label:'Lipid41'},
          {name:'Lipid_4_2', label:'Lipid42'},
          {name:'Lipid_4_3', label:'Lipid43'},
          {name:'Lipid_4_4', label:'Lipid44'}
          ]);
          ...
          setValSchema(Yup.object({
            ...
            Lipid_1_1: Yup.string().required('Required'),
            Lipid_1_2: Yup.string().required('Required'),
            Lipid_1_3: Yup.string().required('Required'),
            Lipid_1_4: Yup.string().required('Required'),
            Lipid_2_1: Yup.string().required('Required'),
            Lipid_2_2: Yup.string().required('Required'),
            Lipid_2_3: Yup.string().required('Required'),
            Lipid_2_4: Yup.string().required('Required'),
            Lipid_3_1: Yup.string().required('Required'),
            Lipid_3_2: Yup.string().required('Required'),
            Lipid_3_3: Yup.string().required('Required'),
            Lipid_3_4: Yup.string().required('Required'),
            Lipid_4_1: Yup.string().required('Required'),
            Lipid_4_2: Yup.string().required('Required'),
            Lipid_4_3: Yup.string().required('Required'),
            Lipid_4_4: Yup.string().required('Required'),
            pick: Yup.bool(),
          }));
          ...
          {name:'FACTAGenome', label:'FACTAGenome'},
          {name:'AminoAcid', label:'Amino Acid'},
          {name:'IPReferences', label:'IPReferences'},
          {name:'PublicationSource', label:'Publication Source'},
          {name:'DOI', label:'DOI'},
          {name:'REFlinks', label:'REFlinks'},
          {name:'Notes', label:'Notes'},
          ...
          setValSchema(Yup.object({
            ...
            FACTAGenome: Yup.string().required('Required'),
            AminoAcid: Yup.string().required('Required'),
            IPReferences: Yup.string().required('Required'),
            PublicationSource: Yup.string().required('Required'),
            DOI: Yup.string().required('Required'),
            REFlinks: Yup.string().required('Required'),
            Notes: Yup.string().required('Required'),
