          ...
          <Card >
            <CardHeader  color={button.currentButton === 0 ? "primary" : "warning" }  stats icon>
              <CardIcon  color={button.currentButton === 0 ? "primary" : "warning" }>
                <IconButton disableTouchRipple={true} onClick={() => onButtonClicked("ids",0)} style={{fontSize: '12px', color: 'white'}}>
                  <StorageIcon />
                  MRNA-UCV-IDS
                </IconButton>
              </CardIcon>
          ...
          <Card >
            <CardHeader color={button.currentButton === 1 ? "primary" : "success"} stats icon>
              <CardIcon color={button.currentButton === 1 ? "primary" : "success"}>
                <IconButton disableTouchRipple={true} onClick={() => onButtonClicked("norvax-lnps",1)} style={{fontSize: '12px', color: 'white'}}>
                  <StorageIcon />
                  NORVAX-LNPS
                </IconButton>
              </CardIcon>
          ...
          <Card >
            <CardHeader color={button.currentButton === 2 ? "primary" : "danger"} stats icon>
              <CardIcon color={button.currentButton === 2 ? "primary" : "danger"}>
                 <IconButton disableTouchRipple={true} onClick={() => onButtonClicked("gb-t-bm-rna-ids",2)} style={{fontSize: '12px', color: 'white'}}>
                  <StorageIcon />
                  GBTBMRNA-IDS
                </IconButton>
              </CardIcon>
          ...
          <Card >
            <CardHeader color={button.currentButton === 3 ? "primary" : "info"} stats icon>
              <CardIcon color={button.currentButton === 3 ? "primary" : "info"}>
                <IconButton disableTouchRipple={true} onClick={() => onButtonClicked("ecam-sma-ids",3)} style={{fontSize: '12px', color: 'white'}}>
                  <StorageIcon />
                  ECAM-SMA-IDS
                </IconButton>
              </CardIcon>
