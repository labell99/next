          ...
          <Card >
            <CardHeader  color={button.currentButton === 0 ? "primary" : "warning" }  stats icon>
              <CardIcon  color={button.currentButton === 0 ? "primary" : "warning" }>
                <IconButton disableRipple disableTouchRipple onClick={() => onButtonClicked("ids",0)} style={{fontSize: '12px', color: 'white'}}>
                  <StorageIcon />
                  MRNA-UCV-IDS
                </IconButton>
              </CardIcon>
          ...
          <Card >
            <CardHeader color={button.currentButton === 1 ? "primary" : "success"} stats icon>
              <CardIcon color={button.currentButton === 1 ? "primary" : "success"}>
                <IconButton disableRipple disableTouchRipple onClick={() => onButtonClicked("norvax-lnps",1)} style={{fontSize: '12px', color: 'white'}}>
                  <StorageIcon />
                  NORVAX-LNPS
                </IconButton>
              </CardIcon>
          ...
          <Card >
            <CardHeader color={button.currentButton === 2 ? "primary" : "danger"} stats icon>
              <CardIcon color={button.currentButton === 2 ? "primary" : "danger"}>
                 <IconButton disableRipple disableTouchRipple onClick={() => onButtonClicked("gb-t-bm-rna-ids",2)} style={{fontSize: '12px', color: 'white'}}>
                  <StorageIcon />
                  GBTBMRNA-IDS
                </IconButton>
              </CardIcon>
          ...
          <Card >
            <CardHeader color={button.currentButton === 3 ? "primary" : "info"} stats icon>
              <CardIcon color={button.currentButton === 3 ? "primary" : "info"}>
                <IconButton disableRipple disableTouchRipple onClick={() => onButtonClicked("ecam-sma-ids",3)} style={{fontSize: '12px', color: 'white'}}>
                  <StorageIcon />
                  ECAM-SMA-IDS
                </IconButton>
              </CardIcon>
