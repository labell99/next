...
const options = {
  ...
  if (dbname === "ids") {
    ...
    var pentries=[
    {id:1, name: ["Vaccine Name","Vaccine Type","Vaccine Target","Emergence","Short Name","Long Name","Vaccine Application","PANGO Link","Conserved","Variant Targets","Description","Category","Type","Subcategory","Notes","Users","AmpTec_Sourcecode","RNAseqCHECK" ], indexes: [2,3,4,6,7,8,5,11,13,14,15,16,17,18,24,23,27,26], menu:"Characterisation"}];
    var entries=[];
    var categories=[
	{id:1, name: ["FACTA. Target","FACTA. Genome","Amino Acid","IPReferences","PublicationSource","DOI","REFlinks"], indexes: [9,10,12,19,21,20,22], menu:"Structure"}];
  };
