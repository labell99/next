...
const options = {
  ...
  var categories=[
    {id:1, name: [{label: "FACTA. Target"},{label: "FACTA. Genome"},{label: "Spike Variants"},{label: "Other Variants"}], menu:"Structure"}
  ];
          ...
          {categories.map(category => (
            <Accordion>
              <AccordionSummary
                 ...
                 id="panel1a-header"
              >
                <Typography variant="h5" className={classes.heading}> {category.name} </Typography>
              </AccordionSummary>
