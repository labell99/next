...
const options = {
  ...
  if (dbname === "ids") {
	setDataTableName("Immunogen Design & Selection");
    var categories=[
      ...
      <GridItem xs={12} sm={12} md={12}>
        <Card>
          <CardHeader color="dark">
            <h4 className={classes.cardTitleWhite}>{dataTableName}</h4>
          </CardHeader>
          <CardBody>
